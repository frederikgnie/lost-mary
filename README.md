...
├── scripts/      pycheck.py  check-evidence.py  no-ask.py  no-punt.py  friction.py  ledger.py  check-spawn.py  permit.py  witness.py  guard-shared-checkouts.py  prune-worktrees.py
